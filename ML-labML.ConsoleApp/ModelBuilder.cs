...
namespace ML_labML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Nina\OneDrive\Документи\Print\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../ML_labML.Model/MLModel.zip";
